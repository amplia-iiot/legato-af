...
//--------------------------------------------------------------------------------------------------
/**
 *  This class serves as the internal native code wrapper for the C layer of the Legato API.
 *
 *  This class is not intended to be used directly.  Instead you should use the other classes of
 *  this package to access the Legato APIs.
 */
//--------------------------------------------------------------------------------------------------
class LegatoJni
{
    ...
    public static native Result ServiceLoop();
    ...
    public static native void LogMessage(long sessionRef, long logLevelRef, int severity,
                                         String file, String method, int line, String message);
