...
public class LogHandler extends Handler
{
    ...
    //----------------------------------------------------------------------------------------------
    /**
     *  Handles the close method, we don't really support this so there's nothing to do here.
     */
    //----------------------------------------------------------------------------------------------
    @Override
    ...
    //----------------------------------------------------------------------------------------------
    /**
     *  Flush out any pending logs.  The other layers handle this already, so there's nothing to do
     *  here.
     */
    //----------------------------------------------------------------------------------------------
    @Override
    ...
    public void publish(LogRecord record)
    {
        ...
        LegatoJni.LogMessage(session.sessionRef,
                             session.logLevelRef,
                             legatoLevel,
