...
{
    /**
     *  Internal native message reference.  This is used by the C code to refer to the actual
     *  message object.
     */
     ...
     *
     *  @param newRef  The native reference to the underlying message object.
     */
    //----------------------------------------------------------------------------------------------
    Message(long newRef)
    {
    ...
    //----------------------------------------------------------------------------------------------
    /**
     *  Send this message out across the attached session.  Do not wait for a response.
     */
    //----------------------------------------------------------------------------------------------
    public void send()
    {
    ...
    //----------------------------------------------------------------------------------------------
    /**
     *  Send this message out across the attached session.  This will not return until a response
